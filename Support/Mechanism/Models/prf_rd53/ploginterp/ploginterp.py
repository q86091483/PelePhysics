    ...
    # The pressure is between two available presssures points
        ...
        # If not we interpolate
            ...
            if (np.isnan(A) or np.isnan(b) or np.isnan(E)):
              print("Here has nan:", reaction)
              print("Coefficient based on P: ", np.interp(np.log10(P), np.log10([P1, P2]), log([A1, A2])))
              print("[A1, A2], log[A1, A2], A_guess: ", A1, A2, log([A1, A2]), A_guess)
              print("[b1, b2], log[b1, b2], b_guess: ", b1, b2, log([b1, b2]), b_guess)
              print("[E1, E2], log[E1, E2], E_guess: ", E1, E2, np.log10([E1, E2]), E_guess)
            if (True):
              print("Interpolation cCoefficient: ", reaction)
              print("P = ", "%.2E"%(P), ", P0 = ", "%.2E"%(P1), "P1 = ", "%.2E"%(P2))
              print("A = ", "%.2E"%(A), ", A1 = ", "%.2E"%(A1), "A2 = ", "%.2E"%(A2))
              print("b = ", "%.2E"%(b), ", b1 = ", "%.2E"%(b1), "b2 = ", "%.2E"%(b2))
              print("E = ", "%.2E"%(E), ", b1 = ", "%.2E"%(E1), "b2 = ", "%.2E"%(E2))
