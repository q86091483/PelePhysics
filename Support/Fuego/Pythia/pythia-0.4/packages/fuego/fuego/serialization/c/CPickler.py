    ...
    def _findClosedCycle(self, mechanism, species):
        ...
        for need in self.needs_running[parent]:
            ...
            if child not in self.lowest_link.keys():
                ...
                print "         Initiate recursion to assign lowlink value "
                    
                self._findClosedCycle(mechanism, child)

                print "         We've finished a recursion! The child that was passed in was: "+child+" with parent "+parent
                print "         The discovery order of the parent is: ", self.lowest_link.keys().index(parent)
                print "         The lowest link value of the parent is: ", self.lowest_link[parent]
                ...
                # This update comes into effect when the child matches the original parent of the search or has a lower link connection from an earlier search than the parent currently does
            ...
            # Note: If the child already has a lowest link value but is NOT in the potential_group, that means it is a part of a previously found group
                ...
                print "         Child has already been visited this recursion "
                print "         The discovery order of the parent is: ", self.lowest_link.keys().index(parent)
                print "         The lowest link value of the parent is: ", self.lowest_link[parent]
                print "         The discovery order of this child is: ", self.lowest_link.keys().index(child)
                print "         The lowest link value of this child is: ", self.lowest_link[child]
